...
public class TransmuteEvent : VoiceEventBase {
    ...
    public TransmuteEvent(Config config) : base(config) {
        _definitions = [
            ("Milk",     ["milk", "calcium", "奶", "钙"], ["Fortified Milk", "奶白金"], () => config.TransmuteMilkEnabled.Value),
            ("Cactus",   ["cactus", "cacti", "仙人掌"], ["Cactus", "仙人球"], () => config.TransmuteCactusEnabled.Value),
            ("Coconut",  ["coconut", "椰子"], ["Coconut", "椰子"], () => config.TransmuteCoconutEnabled.Value),
            ("Apple",    ["apple", "berry", "苹果", "浆果"], ["Red Crispberry", "Yellow Crispberry", "Green Crispberry", "红脆莓", "黄脆莓", "绿脆莓"], () => config.TransmuteAppleEnabled.Value),
            ("Banana",   ["banana", "香蕉"], ["Berrynana Peel Yellow", "莓蕉皮"], () => config.TransmuteBananaEnabled.Value),
            ("Egg",      ["egg", "鸡蛋"], ["Egg", "煎蛋"], () => config.TransmuteEggEnabled.Value),
            ("Fruit",    ["fruit", "水果"], ["Red Crispberry", "Yellow Crispberry", "Green Crispberry", "Kingberry Purple", "Kingberry Yellow", "Kingberry Green", "Berrynana Brown", "Berrynana Yellow", "Berrynana Pink", "Berrynana Blue", "红脆莓", "黄脆莓", "绿脆莓", "紫荔莓", "黄荔莓", "青荔莓", "棕莓蕉", "黄莓蕉", "粉莓蕉", "蓝莓蕉"], () => config.TransmuteFruitEnabled.Value),
            ("Mushroom", ["fungus", "mushroom", "fungi", "funghi", "shroom", "蘑菇", "真菌"], ["Mushroom Normie", "蘑菇"], () => config.TransmuteMushroomEnabled.Value)
        ];
